...
#>                     Est.   S.E.   t val.      p
#> ---------------- ------- ------ -------- ------
#> lag(union)          0.06   0.03     2.28   0.02
#> wks                -0.00   0.00    -1.51   0.13
#> -----------------------------------------------
#> 
#> BETWEEN EFFECTS:
#> ------------------------------------------------------
#>                            Est.   S.E.   t val.      p
#> ----------------------- ------- ------ -------- ------
#> (Intercept)                6.60   0.23    28.53   0.00
#> imean(lag(union))         -0.03   0.03    -0.80   0.42
#> imean(wks)                 0.00   0.00     0.91   0.36
#> blk                       -0.23   0.06    -3.85   0.00
#> fem                       -0.44   0.05    -8.89   0.00
#> ------------------------------------------------------
#> 
...
#>                         Est.   S.E.   t val.      p
#> -------------------- ------- ------ -------- ------
#> lag(union):blk         -0.13   0.12    -1.03   0.31
#> ---------------------------------------------------
#> 
#> p values calculated using df = 3561 
#>  
#> RANDOM EFFECTS:
#> ------------------------------------
