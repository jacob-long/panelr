...
```
    ...
     [3mp values calculated using df = 4153 
     [23m 
     [1mRANDOM EFFECTS:
     [22m------------------------------------
...
```
    ...
     [22m--------------------------------------------
                     Est.   S.E.   t val.      p
    ------------- ------- ------ -------- ------
    wks             -0.00   0.00    -1.43   0.15
    union            0.05   0.03     1.82   0.07
    lag(ms)         -0.04   0.03    -1.19   0.23
    occ             -0.06   0.02    -2.56   0.01
    --------------------------------------------
    ...
     [22m---------------------------------------------------
                            Est.   S.E.   t val.      p
    -------------------- ------- ------ -------- ------
    (Intercept)             6.36   0.21    30.51   0.00
    imean(wks)              0.01   0.00     2.25   0.02
    imean(union)            0.15   0.03     4.48   0.00
    imean(lag(ms))          0.15   0.06     2.80   0.01
    imean(occ)             -0.41   0.03   -13.16   0.00
    blk                    -0.15   0.05    -2.92   0.00
    fem                    -0.33   0.06    -5.17   0.00
    ---------------------------------------------------

     [3mp values calculated using df = 3558 
     [23m 
     [1mRANDOM EFFECTS:
     [22m------------------------------------
      Group      Parameter    Std. Dev. 
...
```
    ...
     [22m------------------------------------------
                   Est.   S.E.   t val.      p
    ----------- ------- ------ -------- ------
    wks            0.00   0.00     1.91   0.06
    union          0.03   0.02     2.29   0.02
    ms            -0.03   0.02    -1.71   0.09
    occ           -0.03   0.01    -1.81   0.07
    ------------------------------------------
    ...
     [22m-------------------------------------------------
                          Est.   S.E.   t val.      p
    ------------------ ------- ------ -------- ------
    (Intercept)           5.91   0.20    28.95   0.00
    imean(wks)            0.01   0.00     2.25   0.02
    imean(union)          0.15   0.03     4.67   0.00
    imean(ms)             0.17   0.05     3.07   0.00
    imean(occ)           -0.41   0.03   -13.31   0.00
    blk                  -0.15   0.05    -2.81   0.00
    fem                  -0.32   0.06    -4.96   0.00
    t                     0.10   0.00    81.29   0.00
    -------------------------------------------------

     [3mp values calculated using df = 4152 
     [23m 
     [1mRANDOM EFFECTS:
     [22m------------------------------------
      Group      Parameter    Std. Dev. 
...
```
    ...
     [22m------------------------------------------
                   Est.   S.E.   t val.      p
    ----------- ------- ------ -------- ------
    wks            0.00   0.00     1.47   0.14
    union          0.02   0.01     1.61   0.11
    ms            -0.04   0.02    -1.97   0.05
    occ           -0.02   0.01    -1.42   0.16
    ------------------------------------------
    ...
     [22m-------------------------------------------------
                          Est.   S.E.   t val.      p
    ------------------ ------- ------ -------- ------
    (Intercept)           5.93   0.20    29.69   0.00
    imean(wks)            0.01   0.00     2.12   0.03
    imean(union)          0.16   0.03     4.90   0.00
    imean(ms)             0.17   0.05     3.25   0.00
    imean(occ)           -0.39   0.03   -13.16   0.00
    blk                  -0.13   0.05    -2.49   0.01
    fem                  -0.31   0.06    -4.90   0.00
    t                     0.10   0.00    54.67   0.00
    -------------------------------------------------
...
```
    ...
    ------------------ ------- ------ -------- ------
    (Intercept)           6.30   0.20    30.85   0.00
    imean(wks)            0.01   0.00     1.93   0.05
    imean(union)          0.09   0.04     2.15   0.03
    imean(ms)             0.25   0.06     3.95   0.00
    imean(occ)           -0.33   0.04    -8.55   0.00
    blk                  -0.15   0.05    -2.81   0.00
    fem                  -0.32   0.06    -4.96   0.00
    -------------------------------------------------
...
```
    ...
    ------------------------------------------------
                         Est.   S.E.   t val.      p
    ----------------- ------- ------ -------- ------
    (Intercept)          6.68   0.02   413.08   0.00
    wks                  0.00   0.00     1.06   0.29
    union                0.06   0.03     2.53   0.01
    ms                  -0.08   0.03    -2.57   0.01
    occ                 -0.08   0.02    -3.32   0.00
    ...
     [3mp values calculated using df = 4159 
     [23m 
     [1mRANDOM EFFECTS:
     [22m------------------------------------
      Group      Parameter    Std. Dev. 
